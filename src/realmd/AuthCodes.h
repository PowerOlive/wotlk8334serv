...
// will only support WoW and WoW:TBC 2.4.2 client build 8278... << old. support 8334, but keep this so I know what maps are compatible

#define EXPECTED_MANGOS_CLIENT_BUILD        {8334, 0}
